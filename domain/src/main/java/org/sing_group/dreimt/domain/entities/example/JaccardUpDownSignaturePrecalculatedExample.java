...
@Table(name = "precalculated_example_jaccard_updown")
public class JaccardUpDownSignaturePrecalculatedExample extends JaccardPrecalculatedExample implements Serializable {
