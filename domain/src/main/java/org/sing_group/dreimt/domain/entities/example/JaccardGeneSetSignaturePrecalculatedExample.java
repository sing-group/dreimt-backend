...
@Table(name = "precalculated_example_jaccard_geneset")
public class JaccardGeneSetSignaturePrecalculatedExample extends JaccardPrecalculatedExample implements Serializable {
