...
public class DefaultCmapResultDao implements CmapResultDao {

  @PersistenceContext
  protected EntityManager em;
  protected DaoHelper<String, CmapResult> dh;

  public DefaultCmapResultDao() {
    super();
  }

  public DefaultCmapResultDao(EntityManager em) {
    this.em = em;
    createDAOHelper();
  }
  ...
  protected void createDAOHelper() {
    this.dh = DaoHelper.of(String.class, CmapResult.class, this.em);
  }

  @Override
  public Optional<CmapResult> get(String workId) {
