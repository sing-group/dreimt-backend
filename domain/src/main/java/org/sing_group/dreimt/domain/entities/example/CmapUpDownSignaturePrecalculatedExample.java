...
@Table(name = "precalculated_example_cmap_updown")
public class CmapUpDownSignaturePrecalculatedExample extends CmapPrecalculatedExample implements Serializable {
