...
public class DefaultJaccardDao implements JaccardResultDao {

  @PersistenceContext
  protected EntityManager em;
  protected DaoHelper<String, JaccardResult> dh;

  public DefaultJaccardDao() {
    super();
  }

  public DefaultJaccardDao(EntityManager em) {
    this.em = em;
    createDAOHelper();
  }
  ...
  protected void createDAOHelper() {
    this.dh = DaoHelper.of(String.class, JaccardResult.class, this.em);
  }

  @Override
  public Optional<JaccardResult> get(String workId) {
