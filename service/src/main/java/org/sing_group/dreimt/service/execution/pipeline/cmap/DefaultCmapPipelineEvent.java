...
public class DefaultCmapPipelineEvent
  implements CmapPipelineEvent, WorkStepEvent, Serializable {
  private static final long serialVersionUID = 1L;

  private final CmapPipelineContext context;
  ...
  public DefaultCmapPipelineEvent(
    CmapPipelineContext context, String description, double progress, ExecutionStatus status
  ) {
  ...
  public DefaultCmapPipelineEvent(
    CmapPipelineContext context, String description, double progress, String runningStepId,
  ...
  @Override
  public CmapPipelineContext getContext() {
    return this.context;
  }
