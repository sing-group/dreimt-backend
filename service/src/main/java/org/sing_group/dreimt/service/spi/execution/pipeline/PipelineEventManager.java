...
> {
  void fireEvent(PC context, ExecutionStatus status, double progress, String description);

  void fireRunningStepEvent(
    PS step, PC context, String stepId, StepExecutionStatus stepStatus, double progress, String description
  );
}
