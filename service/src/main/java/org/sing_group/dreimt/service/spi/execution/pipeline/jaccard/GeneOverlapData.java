...
public interface GeneOverlapData {
  ...
  String getTargetSignatureName();

  JaccardComparisonType getTargetComparisonType();

  JaccardComparisonType getSourceComparisonType();
}
