...
public class DefaultJaccardPipelineContextBuilderFactory implements JaccardPipelineContextBuilderFactory {

  @Override
  public JaccardPipelineContextBuilder createBuilderFor(
    JaccardPipeline pipeline, JaccardPipelineConfiguration configuration, JaccardPipelineEventManager eventManager
  ) {
    return new DefaultJaccardPipelineContextBuilder(pipeline, configuration, eventManager);
  }

  @Override
  public JaccardPipelineContextBuilder createBuilderFor(JaccardPipelineContext context) {
    return new DefaultJaccardPipelineContextBuilder(context);
  }
}
