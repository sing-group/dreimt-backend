...
@Local
public interface CmapQueryService {
  ...
  CmapResult cmapQuery(CmapQueryOptions options);

  Optional<CmapResult> getResult(String resultId);

  boolean validateNumPerm(Integer numPerm);
}
