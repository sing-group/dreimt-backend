  ...
  private JaccardResult jaccardUpDownQuery(JaccardQueryOptions options) {
    final JaccardUpDownSignatureResult result =
      this.jaccardUpDownSignatureDao.create(
        ...
        options.isOnlyUniverseGenes(),
        options.getSignatureListingOptions().getCellType1().orElse(null),
        options.getSignatureListingOptions().getCellSubType1().orElse(null),
        options.getSignatureListingOptions().getCellType2().orElse(null),
        options.getSignatureListingOptions().getCellSubType2().orElse(null),
